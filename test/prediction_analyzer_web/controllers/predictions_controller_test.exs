defmodule PredictionAnalyzerWeb.PredictionsControllerTest do
  ...
  test "GET /predictions", %{conn: conn} do
  ...
  test "GET /predictions for events after midnight", %{conn: conn} do
    vehicle_event = %PredictionAnalyzer.VehicleEvents.VehicleEvent{
      vehicle_id: "v1",
      vehicle_label: "l1",
      is_deleted: false,
    ...
    response =
      conn
      |> get("/predictions?stop_id=70107&service_date=2018-11-18&hour=25")
      |> html_response(200)
